...
int main(int argc, char** argv) {
  ...
  double* x1 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x2 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x3 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x4 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x5 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x6 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x7 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x8 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x9 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x10 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x11 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x12 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x13 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x14 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x15 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x16 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x17 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x18 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x19 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x20 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x21 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x22 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x23 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x24 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x25 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x26 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x27 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x28 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x29 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x30 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x31 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x32 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x33 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x34 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x35 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x36 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x37 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x38 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x39 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x40 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x41 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x42 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x43 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x44 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x45 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x46 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x47 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x48 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x49 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x50 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x51 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x52 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x53 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x54 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x55 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x56 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x57 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x58 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x59 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x60 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x61 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x62 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x63 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
  double* x64 = numa_alloc_onnode(ITEMS * sizeof(double), 1);
