...
int main(int argc, char** argv) {
  ...
  // double* x1 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x2 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x3 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x4 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x5 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x6 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x7 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x8 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x9 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x10 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x11 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x12 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x13 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x14 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x15 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x16 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x17 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x18 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x19 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x20 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x21 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x22 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x23 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x24 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x25 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x26 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x27 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x28 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x29 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x30 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x31 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x32 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x33 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x34 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x35 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x36 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x37 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x38 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x39 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x40 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x41 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x42 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x43 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x44 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x45 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x46 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x47 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x48 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x49 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x50 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x51 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x52 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x53 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x54 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x55 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x56 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x57 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x58 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x59 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x60 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x61 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x62 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x63 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
  // double* x64 = (double*)numa_alloc_onnode(ITEMS * sizeof(double), 0);
