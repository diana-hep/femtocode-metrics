...
int main(int argc, char** argv) {
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    std::cout << "1 GB host -> host: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    std::cout << "1 GB host -> device: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "1 GB device in-place operation: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "1 GB device immutable operation: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "1 GB device const immutable operation: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "1 GB device -> host: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    std::cout << "1 GB host -> pinned: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    std::cout << "1 GB pinned -> host: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "1 GB device -> device: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomics on global <<<32768, 32>>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomics on global <<<32768, 64>>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomics on global <<<32768, " << cdp.maxThreadsPerBlock << ">>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomics by 32 on global <<<32768, 32>>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomics by 32 on global <<<32768, 64>>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomics by 32 on global <<<32768, " << cdp.maxThreadsPerBlock << ">>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit naive thread local by " << cdp.maxThreadsPerBlock << " on global <<<32768, " << cdp.maxThreadsPerBlock << ">>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
  ...
  for (int i = 0;  i < 5;  i++) {
    ...
    cudaDeviceSynchronize();
    std::cout << "hit atomic thread local by " << cdp.maxThreadsPerBlock << " on global <<<32768, " << cdp.maxThreadsPerBlock << ">>>: " << 1e3 * (std::clock() - startTime) / (double) CLOCKS_PER_SEC << " ms" << std::endl;
  }
