...
int main(int argc, char** argv) {
  ...
  double* pool = (double*)hbw_malloc(64 * ITEMS * sizeof(double));

  double* x1 = &pool[0 * ITEMS];
  double* x2 = &pool[1 * ITEMS];
  double* x3 = &pool[2 * ITEMS];
  double* x4 = &pool[3 * ITEMS];
  double* x5 = &pool[4 * ITEMS];
  double* x6 = &pool[5 * ITEMS];
  double* x7 = &pool[6 * ITEMS];
  double* x8 = &pool[7 * ITEMS];
  double* x9 = &pool[8 * ITEMS];
  double* x10 = &pool[9 * ITEMS];
  double* x11 = &pool[10 * ITEMS];
  double* x12 = &pool[11 * ITEMS];
  double* x13 = &pool[12 * ITEMS];
  double* x14 = &pool[13 * ITEMS];
  double* x15 = &pool[14 * ITEMS];
  double* x16 = &pool[15 * ITEMS];
  double* x17 = &pool[16 * ITEMS];
  double* x18 = &pool[17 * ITEMS];
  double* x19 = &pool[18 * ITEMS];
  double* x20 = &pool[19 * ITEMS];
  double* x21 = &pool[20 * ITEMS];
  double* x22 = &pool[21 * ITEMS];
  double* x23 = &pool[22 * ITEMS];
  double* x24 = &pool[23 * ITEMS];
  double* x25 = &pool[24 * ITEMS];
  double* x26 = &pool[25 * ITEMS];
  double* x27 = &pool[26 * ITEMS];
  double* x28 = &pool[27 * ITEMS];
  double* x29 = &pool[28 * ITEMS];
  double* x30 = &pool[29 * ITEMS];
  double* x31 = &pool[30 * ITEMS];
  double* x32 = &pool[31 * ITEMS];
  double* x33 = &pool[32 * ITEMS];
  double* x34 = &pool[33 * ITEMS];
  double* x35 = &pool[34 * ITEMS];
  double* x36 = &pool[35 * ITEMS];
  double* x37 = &pool[36 * ITEMS];
  double* x38 = &pool[37 * ITEMS];
  double* x39 = &pool[38 * ITEMS];
  double* x40 = &pool[39 * ITEMS];
  double* x41 = &pool[40 * ITEMS];
  double* x42 = &pool[41 * ITEMS];
  double* x43 = &pool[42 * ITEMS];
  double* x44 = &pool[43 * ITEMS];
  double* x45 = &pool[44 * ITEMS];
  double* x46 = &pool[45 * ITEMS];
  double* x47 = &pool[46 * ITEMS];
  double* x48 = &pool[47 * ITEMS];
  double* x49 = &pool[48 * ITEMS];
  double* x50 = &pool[49 * ITEMS];
  double* x51 = &pool[50 * ITEMS];
  double* x52 = &pool[51 * ITEMS];
  double* x53 = &pool[52 * ITEMS];
  double* x54 = &pool[53 * ITEMS];
  double* x55 = &pool[54 * ITEMS];
  double* x56 = &pool[55 * ITEMS];
  double* x57 = &pool[56 * ITEMS];
  double* x58 = &pool[57 * ITEMS];
  double* x59 = &pool[58 * ITEMS];
  double* x60 = &pool[59 * ITEMS];
  double* x61 = &pool[60 * ITEMS];
  double* x62 = &pool[61 * ITEMS];
  double* x63 = &pool[62 * ITEMS];
  double* x64 = &pool[63 * ITEMS];
